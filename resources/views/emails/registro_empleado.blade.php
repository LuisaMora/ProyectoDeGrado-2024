...
<html>
<head>
    <title>Confirmación de Empleado</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Nos complace informarte que has sido registrado en {{config('app.name')}}.</p>

            <h3>Bienvenido</h3>
            <p><strong>Nombre del Restaurante:</strong> {{ $restaurante->nombre }}</p>

            <h3>Tus credenciales de acceso como empleado son:</h3>
            <ul>
